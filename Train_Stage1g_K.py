...
parser.add_argument('-d', '--data', metavar='DIR', default='D:\\Datasets\\', help='path to dataset')
...
# -----------------------------------------------------------------------------
parser.add_argument('-mm', '--m_model', metavar='Mono Model', default='FAL_net2B', choices=model_names)
