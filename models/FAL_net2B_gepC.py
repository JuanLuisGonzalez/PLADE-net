...
def FAL_net2B_gepC(data=None, no_levels=49):
...
class BackBone(nn.Module):
    def __init__(self, batchNorm=True, no_in=3, no_flow=1, no_out=64, no_ep=8):
        ...
        self.conv5 = conv_elu(self.batchNorm, 256 + no_ep, 512, pad=1, stride=2)
        self.conv5_1 = residual_block(512)
        self.conv6 = conv_elu(self.batchNorm, 512 + no_ep, 512, pad=1, stride=2)
        ...
        self.iconv6 = conv_elu(self.batchNorm, 512 + 256, 512)
