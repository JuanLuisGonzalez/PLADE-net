...
def FAL_net2B_g(data=None, no_levels=49):
...
class BackBone(nn.Module):
    def __init__(self, batchNorm=True, no_in=3, no_flow=1, no_out=64):
        ...
        self.conv1 = conv_elu(self.batchNorm, 64 + 2 + no_flow, 128, pad=1, stride=2)
        self.conv1_1 = residual_block(128)
        self.conv2 = conv_elu(self.batchNorm, 128 + 64 +2, 256, pad=1, stride=2)
        self.conv2_1 = residual_block(256)
        self.conv3 = conv_elu(self.batchNorm, 256 + 2, 256, pad=1, stride=2)
        self.conv3_1 = residual_block(256)
        self.conv4 = conv_elu(self.batchNorm, 256 + 2, 256, pad=1, stride=2)
        self.conv4_1 = residual_block(256)
        self.conv5 = conv_elu(self.batchNorm, 256 + 2, 256, pad=1, stride=2)
        self.conv5_1 = residual_block(256)
        self.conv6 = conv_elu(self.batchNorm, 256 + 2, 256, pad=1, stride=2)
