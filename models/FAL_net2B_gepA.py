...
def FAL_net2B_gepA(data=None, no_levels=49):
...
class BackBone(nn.Module):
    def __init__(self, batchNorm=True, no_in=3, no_flow=1, no_out=64, no_ep=8):
        ...
        self.conv2 = conv_elu(self.batchNorm, 128 + 64 + no_ep, 128, pad=1, stride=2)
        self.conv2_1 = residual_block(128)
        self.conv3 = conv_elu(self.batchNorm, 128 + no_ep, 128, pad=1, stride=2)
        self.conv3_1 = residual_block(128)
        self.conv4 = conv_elu(self.batchNorm, 128 + no_ep, 256, pad=1, stride=2)
        ...
        self.iconv2 = conv_elu(self.batchNorm, 128 + 64, 128)
...
class FAL_net(nn.Module):
    ...
    def forward(self, input_left, in_grid, min_disp, max_disp, ret_disp=True, ret_subocc=False, ret_pan=False):
        ...
        dlog = self.backbone(input_left, in_grid, flow)
