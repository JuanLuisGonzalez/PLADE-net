...
def FAL_net2B(data=None, no_levels=49):
...
class BackBone(nn.Module):
    def __init__(self, batchNorm=True, no_in=3, no_flow=1, no_out=64):
        ...
        self.conv2 = conv_elu(self.batchNorm, 128 + 64, 256, pad=1, stride=2)
        self.conv2_1 = residual_block(256)
        self.conv3 = conv_elu(self.batchNorm, 256, 256, pad=1, stride=2)
