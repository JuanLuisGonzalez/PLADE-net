...
parser.add_argument('-no_levels', '--no_levels', default=64, help='Number of quantization levels in MED')
parser.add_argument('-perc', '--a_p', default=0.01, help='Perceptual loss weight')
parser.add_argument('-smooth', '--a_sm', default=0.1 * 2 / 512, help='Smoothness loss weight')
# ------------------------------------------------------------------------------
...
parser.add_argument('--epoch_size', default=7400, type=int, metavar='N',
...
#                     default='Kitti_stage1g/10-31-10_11/FAL_net2B_gep2,e52es7400,b8,lr0.0001/checkpoint.pth.tar',
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_loss = train(train_loader0, train_loader1, m_model, g_optimizer, epoch)
...
def train(train_loader0, train_loader1, m_model, g_optimizer, epoch):
    global args
    ...
    for i, (input_data0, input_data1) in enumerate(train_loader):
        ...
        ### Run forward pass ###
        rpan, ldisp = m_model(left_view, in_grid, min_disp, max_disp, ret_disp=True, ret_pan=True, ret_subocc=False)
